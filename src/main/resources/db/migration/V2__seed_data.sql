-- ============================================================
-- V2: 샘플 시드 데이터 (단수형 테이블명 적용)
-- ============================================================

-- ── 파트너 ────────────────────────────────────────────────────
INSERT INTO partner (id, name, email, phone, business_number, status)
...
-- ── 숙소 ──────────────────────────────────────────────────────
INSERT INTO property (id, partner_id, name, description, category, status,
...
-- ── 객실 타입 ──────────────────────────────────────────────────
-- 그랜드 서울 호텔
INSERT INTO room_type (id, property_id, name, description, max_occupancy, bed_type, size_sqm)
...
INSERT INTO rate_plan (id, room_type_id, name, cancel_policy, breakfast_included, base_price, is_active)
...
INSERT INTO room_inventory (room_type_id, date, total_count, available_count)
WITH RECURSIVE d AS (
...
-- ── 고객 ──────────────────────────────────────────────────────
INSERT INTO customer (id, email, name, phone)
